...
public:
    ...
    MersenneTwister(MersenneTwister&&) = delete;
    MersenneTwister& operator=(MersenneTwister&&) = delete;
};

extern thread_local MersenneTwister mt_generator;
...
extern std::atomic<u64> mt_counter;
